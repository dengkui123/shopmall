<template>
  <div id="hy-swiper">
    ...
    <div class="turn-pages">
      <slot name="turnpages" v-if="showturnpages && slideCount > 1">
        <div class="left-turn" @click="previous"><i class="iconfont icon-zuo"></i></div>
        <div class="right-turn" @click="next"><i class="iconfont icon-you"></i></div>
      </slot>
    </div>
  </div>
</template>
